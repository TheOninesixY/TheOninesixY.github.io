...
features:
  ...
  - title: "一些问题"
    details: "1. 为什么我的主域名前面是The开头的 <br> 答：我之前那个ID为OninesixY的GitHub由于邮箱丢失登不上了 <hr> 2. 为什么我网站那么多域名 <br> 答： 因为我觉得多几个总比少几个好 <hr> 3. 为什么我网站那么达芬 <br> 答： 我都闲着没事干了你还要啥质量 <hr> 4. 我为什么要弄这个网站 <br> 答：因为我在很小的时候就希望我有一个网站，那时我还只会用Canva来弄个带许多超链接的项目，然后分享为网址。而现在长大了，我认识到了NodeJS、React、VitePress、Markdown……我就打算用VitePress搭配GitHubActions来搭建一个我小时候觉得搭建起来超难的网站。其实搭建起来我觉得还是蛮简单了，装个NodeJS再装个Yarn，然后初始化一个VitePress项目，改改文件再写写config，再加上一些自己想要的东西，再配置git来上传到仓库，然后配置deploy.yaml，来实现一个超酷的如果识别到git更新中dist文件夹没有更新，就云端build，而如果dist文件夹有更新，就直接用dist文件夹里的，省去云端build，更快"